      ...
      <div className='z-10 container mx-auto max-w-md'>
        <Link href='/' className='mb-8 flex items-center justify-center space-x-2'>
          <div className='bg-obsidian-accent flex h-8 w-8 items-center justify-center rounded-full'>
            <span className='text-obsidian-darkest font-bold'>E</span>
          </div>
          <span className='text-obsidian-text text-xl font-bold'>EchoNotes</span>
        </Link>
          ...
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
              <div className='space-y-2'>
                <Label htmlFor='firstName' className='text-obsidian-text'>
                  First Name
                </Label>
                <Input
                  id='firstName'
              ...
              <div className='space-y-2'>
                <Label htmlFor='email' className='text-obsidian-text'>
                  Email
                </Label>
                <Input
                  id='email'
              ...
              <div className='space-y-2'>
                <Label htmlFor='password' className='text-obsidian-text'>
                  Password
                </Label>
                <Input
                  id='password'
              ...
              <div className='space-y-2'>
                <Label htmlFor='nick' className='text-obsidian-text'>
                  Nickname (optional)
                </Label>
                <Input
                  id='nick'
              ...
              <div className='space-y-2'>
                <Label htmlFor='lastName' className='text-obsidian-text'>
                  Last Name (optional)
                </Label>
                <Input
                  id='lastName'
